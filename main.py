...
def print_runtime_banner():
    ...
    print(
        "NEXRYN :: ADAPTIVE COGNITIVE RUNTIME"
    )
    ...
    print(
        "BOOT MODE :: META-COGNITIVE EXECUTION"
    )
...
parser.add_argument(
    ...
    help=
    "Directory containing ARC tasks"
)
...
parser.add_argument(
    ...
    help=
    "Number of ARC training tasks executed per runtime cycle"
)
...
parser.add_argument(
    ...
    help=
    "Reset the persistent training batch cursor before execution"
)
...
try:
    ...
    concept_counts = {
        ...
        for concept in initial_ledger_report.get(
            "concepts",
            []
        )
    ...
    print(
        "NEXRYN :: TRAINING ASSISTANT BATCH"
    )
    ...
    for task_file in task_files:
        ...
        print(
            f"NEXRYN :: RUNNING TASK :: {task_file}"
        )
    ...
    results = {
        ...
        "tasks_discovered":
        len(discovered_task_files),

        "discovered_task_files":
        discovered_task_files,

        "training_assistant_batch":
        training_batch,
...
if args.verbose and isinstance(
    results,
    dict
):
