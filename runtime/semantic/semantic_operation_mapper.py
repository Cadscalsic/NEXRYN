...
SEMANTIC_OPERATION_MAP = {
    ...
    "color_preservation": ("preserve_colors", 0.92, "color_operations"),
    ...
    "shape_preservation": ("preserve_shape", 0.90, "geometric_operations"),
    "size_preservation": ("preserve_size", 0.90, "geometric_operations"),
    "density_preservation": ("preserve_density", 0.88, "growth_operations"),
    ...
    "symmetry_reasoning": ("preserve_symmetry", 0.84, "symmetry_operations"),
